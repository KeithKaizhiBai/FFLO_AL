...
"${PYTHON_BIN}" "${REPORT_ROOT}/scripts/phase_qwindow_delta_refinement_audit.py" run-delta   --report-root "${REPORT_ROOT}"   --rank "${SLURM_ARRAY_TASK_ID}"   --world-size "${SLURM_ARRAY_TASK_COUNT}"   --device cuda:0
